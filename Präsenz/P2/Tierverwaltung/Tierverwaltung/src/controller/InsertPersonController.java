...
public class InsertPersonController implements EventHandler<ActionEvent> {
    ...
    public InsertPersonController(TextField vorname, TextField nachname, ToggleGroup geschlecht,
    														TextField alter, TextField bild, TextField email,
    														ToggleGroup tier) {
   	...
   	public void handle(ActionEvent e) {
   		...
   		if(t.getText().equals("ja")) {
   			Besitzer b = new Besitzer(vorname.getText(), nachname.getText(), 
					g.getText(), Integer.parseInt(alter.getText()), 
					bild.getText(), email.getText());

   			b.addTier(Tiere.getLast());
   			Personen.addDefault(b);
   		} else {
   			NonBesitzer b = new NonBesitzer(vorname.getText(), nachname.getText(), 
					g.getText(), Integer.parseInt(alter.getText()), 
					bild.getText(), email.getText());
