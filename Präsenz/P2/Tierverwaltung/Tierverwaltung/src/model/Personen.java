...
public class Personen {
	...
	public static ObservableList<Person> getDefaultList() {
		...
		// Person 1
		Besitzer albert = new Besitzer(
							"Albert","Einstein","m",49,"einstein.jpeg","albert.einstein@beuth-hochschule.de");
		...
		// Person
		Besitzer vater = new Besitzer(
				"Vater", "Einstein","m",83,"einstein.jpeg","vater.einstein@beuth-hochschule.de");
		vater.addTier(new Hund("Dackel", 3, "Freddy"));
		
		NonBesitzer mutter = new NonBesitzer(
					"Mutter", "Einstein","w",79,"einstein.jpeg","mutter.einstein@beuth-hochschule.de");
		
		Besitzer schwester1 = new Besitzer(
				"Kleine Schwester", "Einstein","w",34,"einstein.jpeg","schwester1.einstein@beuth-hochschule.de");
		
		schwester1.addTier(new Vogel("Sittich", 12, "Hans"));
		
		NonBesitzer bruder3 = new NonBesitzer(
					"Kleiner Bruder","Einstein","m",25,"einstein.jpeg","bruder3.einstein@beuth-hochschule.de");
		bruder3.addEmail("bruder3.einstein@beuth-hochschule.de");
		bruder3.addEmail("bruder3.einstein@beuth-hochschule.de");
		
		NonBesitzer schwester2 = new NonBesitzer(
				"Groﬂe Schwester", "Einstein","m",53,"einstein.jpeg","schwester2.einstein@beuth-hochschule.de");
