...
import fxge1.controller.InsertPersonController;
...
public class DialogXMLInsert {
    ...
    public DialogXMLInsert(Stage primaryStage) {
        this.primaryStage = primaryStage;
    }

    public Stage enterPerson(String verz, String filename, boolean xml) {

        Stage secondStage = new Stage();
        secondStage.setTitle("Persondaten");
        ...
        RadioButton j = new RadioButton("ja");
        j.setToggleGroup(group1);
        j.setOnAction(new InsertDialogController(primaryStage, false, true));

        RadioButton n = new RadioButton("nein");
        n.setToggleGroup(group1);
        ...
        Label label8 = new Label("Dateiname");
        label8.setMinWidth(70);
        TextField datei = new TextField();
        datei.setMinWidth(50);
        ArrayList<Node> enter8 = new ArrayList<>();
        enter8.add(label8);
        enter8.add(datei);
        HBox enter8box = Utils.setElementBox(enter8);

        Button submit = new Button("Submit");
        submit.setOnAction(new InsertPersonController(vorname, nachname, group, alter, bild, email, group1, datei));
        ...
        vbox.getChildren().addAll(enter8box, enter1box, enter2box, enter3box, enter4box, enter5box, enter6box,
                enter7box, buttonbox);
